[![Stories in Ready](https://badge.waffle.io/HerrLoesch/DynamicSpecs.png?label=ready&title=Ready)](https://waffle.io/HerrLoesch/DynamicSpecs) [![Stories in Done](https://badge.waffle.io/HerrLoesch/DynamicSpecs.svg?label=done&title=Done)](http://waffle.io/HerrLoesch/DynamicSpecs) [![Build status](https://ci.appveyor.com/api/projects/status/w325gb28ccbai14w?svg=true)](https://ci.appveyor.com/project/HerrLoesch/dynamicspecs)
